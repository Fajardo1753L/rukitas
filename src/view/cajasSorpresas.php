...
<head>
    ...
    <link rel="stylesheet" href="./resource/cajasSorpresas.css">
...
<body>
    <div class="content__title">
        <h2 class="title__productos"><i class="fa fa-heart" aria-hidden="true"></i> Cajas Sorpresas <i class="fa fa-heart" aria-hidden="true"></i></h2>
    </div>   
    <section class="content__cajas">
        <?php 
            require "../lib/cajas.php";
        ?>
    </section>
...
<script src="./resource/cajas.js"></script>
